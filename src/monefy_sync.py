...
def _resolve_most_recent_file(folder_path: Path) -> Path:
    files = sorted(
...
def run_sync(
    ...
    """Clear Monefy sheet values and copy the most recent file in MONEFY_FOLDER."""
    LOGGER.debug(
    ...
    csv_path = _resolve_most_recent_file(folder_path)
